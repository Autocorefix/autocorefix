...
import {
  Wrench, ClipboardList, Users, BarChart2, Shield,
  CheckCircle2, ChevronRight, ArrowRight, Smartphone, TrendingUp, FileText,
} from 'lucide-react'
      ...
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-sm border-b border-slate-100">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm text-slate-600">
            <a href="#funciones"    className="hover:text-[#2563EB] transition-colors">Funciones</a>
            <a href="#como-funciona" className="hover:text-[#2563EB] transition-colors">Cómo funciona</a>
            <a href="#precios"      className="hover:text-[#2563EB] transition-colors">Precios</a>
